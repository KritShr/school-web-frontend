      ...
      <div className={styles.contact4}>
        ...
        <div className="mt-10 flex gap-3 lg:gap-6">
          ...
          <div className="px-10 py-7 w-full justify-center -bg--color-whitesmoke-100 rounded-md">
            <h2  className="text-2xl leading-10 text-center font-bold -text--color-seagreen mb-3">OUR MISSION</h2>
          ...
          {/** our vision */}
          <div className="px-10 py-7 w-full justify-center -bg--color-whitesmoke-100 rounded-md">
            <h2  className="text-2xl leading-10 text-center font-bold -text--color-seagreen mb-3">OUR VISION</h2>
            <h3 className="text-2xl">
